    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('admin/web-publikasi/index') }}">Manajemen publikasi</a></li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    <a href="{{url('admin/web-publikasi/create')}}" class="btn btn-primary"><i class="fa fa-upload"></i> Upload publikasi</a>
                    <a href="{{url('admin/web-publikasi/edit', $publikasi->publikasi_id)}}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit publikasi</a>
                </div>
...
<div class="row clearfix">
    <div class="col-12">
        <div class="card single_post">
            <div class="body">
            <h2 class="text-bold mb-5" style="font-weight: bold;">{{$publikasi->publikasi_judul}}</h2>
                <div class="img-post">
                    <img class="d-block img-fluid" style="height: 300px; width: 100%; object-fit: contain; float:left;" src="{{url('public')}}/web/publikasi/{{$publikasi->publikasi_cover}}" alt="First slide">
                </div>
                
                <p class="text-lowercase">{!! $publikasi->publikasi_isi !!}</p>
            </div>                        
        </div>
