    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('admin/web-berita/index') }}">Manajemen Berita</a></li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    ...
                    <a href="{{url('admin/web-berita/edit', $berita->berita_id)}}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit Berita</a>
                </div>
...
<div class="row clearfix">
    <div class="col-12">
        <div class="card single_post">
            <div class="body">
            <h2 class="text-bold mb-5" style="font-weight: bold;">{{$berita->berita_judul}}</h2>
                <div class="img-post">
                    <img class="d-block img-fluid" src="{{url('public')}}/web/berita/{{$berita->berita_cover}}" alt="First slide">
                </div>
                
                <p class="text-lowercase">{!! $berita->berita_isi !!}</p>
            </div>                        
        </div>
