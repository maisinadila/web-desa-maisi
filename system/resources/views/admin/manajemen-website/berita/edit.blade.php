    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{url('admin/web-berita/index')}}">Manajemen Berita</a></li>
...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{url('admin/web-berita/update', $berita->berita_id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="body">
                    <div class="form-group">
                        <input type="text" name="judul" class="form-control" placeholder="Judul Berita" value="{{$berita->berita_judul}}" />
                    </div>
                
                    <div class="form-group m-t-20 m-b-20">
                        <input type="file" name="file" class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp">
                        <small id="fileHelp" class="form-text text-muted">Upload Gambar dari berita mu di sini.</small>
                    </div>
