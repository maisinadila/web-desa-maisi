...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{url('admin/web-layanan/update', $layanan->layanan_id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="body">
                    <div class="form-group">
                        <input type="text" name="nama" class="form-control" placeholder="Nama layanan" value="{{$layanan->layanan_nama}}" />
                    </div>
                    ...
                    <textarea name="syarat" class="summernote" cols="30" rows="10">
                      {{ $layanan->layanan_syarat }}
                    </textarea>
