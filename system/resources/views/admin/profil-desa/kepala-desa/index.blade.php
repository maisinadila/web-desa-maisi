...
<div class="row clearfix">
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-body">
                <h3>Kepala Desa & Sambutan</h3>
                <a href="{{url('admin/profil-desa/kepala-desa-dan-sambutan/edit',$profil->profil_id)}}" class="btn btn-dark">Edit Kepala Desa & Sambutan</a>
                <p>{!!nl2br($profil->sambutan_kepala)!!}</p>
            </div>
        </div>
    </div>
