    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item active"><a href="{{url('admin/manajemen-persuratan/s-masuk')}}">Surat Masuk</a></li>
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <embed src="{{url('public/surat-masuk', $surat->surat_file)}}" type="application/pdf" width="100%" height="600px" />
                </div>
            </div>
        </div>
    </div>
