            ...
            <div class="d-flex flex-row-reverse">
                <div class="page_action">
                    ...
                    <a href="#largeModal" data-toggle="modal" data-target="#largeModal" class="btn btn-primary">
                        <i class="fa fa-plus"></i> Surat Keluar
                    </a> 
                    <!-- Large Size -->
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{url('admin/manajemen-persuratan/s-keluar/store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('public/surat-keluar', $data->surat_file)}}" download><i class="fa fa-file"></i> Download</a>
                            </td>
                            
                            <td>
                                <div class="btn-group">
                                    <a href="{{url('admin/manajemen-persuratan/s-keluar/detail', $data->surat_id)}}" class="btn btn-primary">Lihat</a>
                                    <a href="{{url('admin/manajemen-persuratan/s-keluar/delete', $data->surat_id)}}" class="btn btn-danger">delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
