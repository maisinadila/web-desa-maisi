...
<div class="row clearfix">
  <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{url('admin/manajemen-persuratan/registrasi-surat/surat-keterangan-kehilangan/createtambahan', $surat->surat_id)}}"  method="post">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label >Barang yang Hilang</label>
                        <textarea class="form-control" name="barang" id="" cols="10" rows="3"></textarea>
                        <small id="emailHelp" class="form-text text-muted">jika barang yang hilang bukan hanya satu maka langsung jelaskan di sini.</small>
                    </div>
                    <div class="form-group">
                        <label >Alasan Hilang</label>
                       <textarea class="form-control" name="alasan" id="" cols="10" rows="3"></textarea>
                    </div>
