	...
	<table>
		...
		<tr>
			...
			<tr>
				...
				<td>:</td>
				<td>{{ucwords($detailmodel->tempat_lahir_ayah_istri)}}, {{$detailmodel->tgl_lahir_ayah_istri}}</td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
				<td>:</td>
				<td>{{$detailmodel->jk_ayah_istri}}</td>
			</tr>
			<tr>
				<td>Warga Negara</td>
				<td>:</td>
				<td>{{$detailmodel->kewarganegaraan_ayah_istri}}</td>
			</tr>
			<tr>
				<td>Agama</td>
				<td>:</td>
				<td>{{$detailmodel->agama_ayah_istri}}</td>
			</tr>
			<tr>
				<td>Pekerjaan</td>
				<td>:</td>
				<td>{{$detailmodel->pekerjaan_ayah_istri}}</td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td>:</td>
				<td>{{ucwords($detailmodel->alamat_ayah_istri)}}</td>
			</tr>
			<tr></tr>
			<tr></tr>
			<tr>
			...
			<tr>
				<td>Nama</td>
				<td>:</td>
				<td>{{ucwords($detailmodel->nama_ibu_istri)}}</td>
			</tr>
			<tr>
				<td>Tempat dan Tanggal Lahir</td>
				<td>:</td>
				<td>{{ucwords($detailmodel->tempat_lahir_ibu_istri)}}, {{$detailmodel->tgl_lahir_ibu_istri}}</td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
				<td>:</td>
				<td>{{$detailmodel->jk_ibu_istri}}</td>
			</tr>
			<tr>
				<td>Warga Negara</td>
				<td>:</td>
				<td>{{$detailmodel->kewarganegaraan_ibu_istri}}</td>
			</tr>
			<tr>
				<td>Agama</td>
				<td>:</td>
				<td>{{$detailmodel->agama_ibu_istri}}</td>
			</tr>
			<tr>
				<td>Pekerjaan</td>
				<td>:</td>
				<td>{{$detailmodel->pekerjaan_ibu_istri}}</td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td>:</td>
				<td>{{ucwords($detailmodel->alamat_ibu_istri)}}</td>
			</tr>
			<tr></tr>
			<tr></tr>
			<tr>
