...
<div class="card mt-3">
	<div class="card-body">
		<div class="col-md-12">
			...
			<a href="{{url('admin/manajemen-persuratan/registrasi-surat/surat-keterangan-domisili',$detail->kode_token)}}/ttd" class="btn btn-success float-right"><i class="fa fa-qrcode"></i> TTD Surat</a>
			@endif
		</div>
	</div>
</div>
