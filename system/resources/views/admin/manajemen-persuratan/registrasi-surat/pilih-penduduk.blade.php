  ...
  $.ajax({
     ...
     success:function(data){
      ...
      for (var i = 0; i < data['hasil'].length; i++) {
        ...
        `<a href="{{url('admin/manajemen-persuratan/registrasi-surat',$template->nama_file)}}/${id}" class="btn btn-primary mt-3 float-right" type="submit">Pilih Penduduk</a>` +
        `</td>` +
        `</tr>`;
    }
