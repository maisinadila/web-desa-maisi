<div class="container">
	...
	<table>
		...
		<tr>
			<td colspan="3">
				Atas lamaran pekerjaan yang bersangkutan kepada {{$surat->param->tujuan}}
				agar dapat diterima bekerja sebagai karyawan dengan pertimbangan yang bersangkutan adalah Putra/Putri daerah asli
				Desa {{$desa->nama}} Kecamatan {{$desa->kecamatan}} Kabupaten {{$desa->kabupaten}} Provinsi {{$desa->provinsi}}
			</td>
		</tr>
		<tr>
			<td></td>
