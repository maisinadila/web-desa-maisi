<div class="container">
	...
	<table>
		...
		<tr>
			<td>Merk/Nama Tempat Usaha</td>
			<td>:</td>
			<td>{{$surat->param->nama_usaha}}</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
			<td colspan="3">Untuk mengajukan / membuat Surat Ijin Tempat Usaha (SITU), 
				membuka usaha / CV. {{$surat->param->usaha_cv}} 
				yang bergerak di bidang {{$surat->param->bidang}} 
				yakni sebagai {{$surat->param->sebagai}} 
				Kepada Bapak Bupati Ketapang.</td>
		</tr>
		<tr>
			<td colspan="3">
