	...
	<table>
		...
		<tr>
			<td colspan="3">
				...
				Kepada yang namanya tersebut di atas telah diberikan Rekomendasi untuk pembuatan
				<b>Surat Keterangan Kesehatan (SKK)</b> di Puskesmas {{$surat->param->puskesmas}} 
				guna untuk {{$surat->param->tujuan}}.
			</td>
		</tr>
		<tr>
			<td></td>
