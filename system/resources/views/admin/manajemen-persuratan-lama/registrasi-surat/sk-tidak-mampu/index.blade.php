                ...
                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                    ...
                    <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                            <div class="btn-group">
                                <a href="{{url('admin/manajemen-persuratan/registrasi-surat',$template->nama_file)}}/{{$s->surat_id}}/show" class="btn btn-primary btn-sm">Lihat</a>

                                <a href="{{url('admin/manajemen-persuratan/registrasi-surat',$template->nama_file)}}//{{$s->surat_id}}cetak" target="_blank" class="btn btn-dark btn-sm">Cetak</a>
