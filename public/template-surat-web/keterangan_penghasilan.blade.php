	...
	<table>
		...
		<tr>
			<td colspan="3">
				...
				Rp. {{number_format($surat->param->penghasilan_min)}} s/d
				Rp. {{number_format($surat->param->penghasilan_max)}} dalam setiap bulannya 
				yang bersumber dari pekerjaan sebagai {{$surat->param->pekerjaan}}
			</td>
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			<td colspan="3">Demikian Surat Keterangan Penghasilan ini dibuat dengan data yang sebenar-benarnya agar dapat digunakan sebagaimana mestinya.</td>
		</tr>
	</table>
